...
* Les canaux push serveur-vers-client (notification mobile, WebSocket, SSE, webhook client) SONT AUTORISÉS comme signaux d'éveil/UX, mais NE SONT PAS source de vérité métier.
