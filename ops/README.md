...
Runbooks fonctionnels cross-project pour l'exploitation de Retaia.

Statut:

* non normatif
* complete les contrats/policies normatifs
* ne remplace pas les guides d'implementation locaux des repos consommateurs
