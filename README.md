...
- OpenAPI sources:
  ...
  - [`api/openapi/v1.1.yaml`](api/openapi/v1.1.yaml) (`v1.1+` track: MCP and dépendantes de l'AI features validated in this phase, some testable earlier behind feature flags)
