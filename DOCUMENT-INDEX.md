...
| `ui/KEYBOARD-SHORTCUTS-REGISTRY.md` | `NON_NORMATIVE` | UI research/recommendation | `UI_WEB` | `v1` |
| `ui/README.md` | `NON_NORMATIVE` | UI overview | `UI_WEB,CONTRIBUTORS` | `v1` |
| `ui/UI-GLOBAL-SPEC.md` | `NON_NORMATIVE` | UI research/recommendation | `UI_WEB` | `v1` |
| `ui/UI-REFONTE-RECOMMANDATION.md` | `NON_NORMATIVE` | UI research/recommendation | `UI_WEB` | `v1` |
| `ui/UI-UX-BRIEF-DESIGNER.md` | `NON_NORMATIVE` | UI research/recommendation | `UI_WEB` | `v1` |
| `ui/UI-WIREFRAMES-TEXTE.md` | `NON_NORMATIVE` | UI research/recommendation | `UI_WEB` | `v1` |
