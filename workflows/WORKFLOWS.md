...
* Si la migration `/.retaia` échoue (create/update atomique ou upgrade de schéma requis), Core DOIT échouer explicitement au boot/update (pas de mode dégradé implicite).
