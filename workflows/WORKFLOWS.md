...
* Si la migration `/.retaia` échoue (create/update atomique ou upgrade requis de `/.retaia.version`), Core DOIT échouer explicitement au boot/update (pas de mode dégradé implicite).
